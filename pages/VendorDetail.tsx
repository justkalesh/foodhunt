...
const VendorDetail: React.FC = () => {
    ...
    const handleDeleteReview = async () => {
        ...
        setIsDeleting(true);
        const res = await api.vendors.deleteReview(deleteReviewId);
        if (res.success) {
                                        ...
                                        <div key={r.id} className="pb-4 border-b dark:border-gray-700 last:border-0">
                                            <div className="flex justify-between items-start mb-1">
                                                ...
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    {user?.role === 'admin' && (
                                                        <button onClick={() => setDeleteReviewId(r.id)} className="text-red-500 hover:text-red-700"><Trash2 size={14} /></button>
                                                    )}
                                                </div>
                                            </div>
